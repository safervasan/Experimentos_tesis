...
title('Frame 1 del video reconstruido con conjugate gradient');
subplot(5,3,14)
imshow(A_rec2(:, :, 150)); % Frame 150 del video reconstruido con conjugate gradient
title('Frame 150 del video reconstruido con conjugate gradient');
subplot(5,3,15)
imshow(A_rec2(:, :, 300)); % Frame 300 del video reconstruido con conjugate gradient
title('Frame 300 del video reconstruido con conjugate gradient');
