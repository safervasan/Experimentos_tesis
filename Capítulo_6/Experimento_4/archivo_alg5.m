...
%% Algoritmo 5: reducción de ruido en las imágenes 4, 31 y 82
...
F = least_square_alg5(X,Y, iterMax, s, tol);
...
for j=1:3
    ...
    texto = ['Los valores ssim y el error cuadrático medio ' ...
        'al reducir el ruido usando el Algoritmo 5 en la imagen ', num2str(lista(j)), ' vienen dados por'];
...
text = ['El tiempo de ejecución del Algoritmo 5 viene dado por ', toc];
disp(texto)
